...
public class MoveJump extends Move {
        ...
        if (board.getField(offX1, offY1).getChecker() != null) {
          ...
          if (board.getField(twiceOffX1, twiceOffY1).getChecker() == null) {
            ...
            if (twiceOffX1 == x2 && twiceOffY1 == y2) {
              ...
              if (recursiveValidateMove(twiceOffX1, twiceOffY1, x2, y2, board, visited)) {
                return true;
              } else {
                continue;
              }
  ...
  private boolean recursiveValidateMove(Integer x1, Integer y1, Integer x2, Integer y2, Board board, List<Field> visitedFields) {
